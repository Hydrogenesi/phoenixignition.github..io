...
Explore the complete documentation of the Phoenix system:

- **[📘 Home](wiki/Home.md)** — Introduction to the Codex
- **[🌀 Origin Cycle](wiki/Origin-Cycle.md)** — Phases I–IV of cosmic emergence
- **[🧘 Micro-Apex Practice](wiki/Micro-Apex-Practice.md)** — Human-scale recursion training
- **[📊 Recursion Diagrams](wiki/Recursion-Diagrams.md)** — Visual engine schematics
...
- 🌟 Interactive Nano-Star Evolution Simulation
- 🔥 Phoenix Origin Cycle visualization

---

## The Ceremonial Compression

**Split if you can.  
Consume if you must.  
Return through the loop.**
